...
-- 导出 sanshanblog 的数据库结构
CREATE DATABASE IF NOT EXISTS `sanshanblog` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `sanshanblog`;

-- 导出  表 sanshanblog.blog_vote 结构
...
-- 数据导出被取消选择。
-- 导出  表 sanshanblog.ip_blog_vote 结构
...
-- 数据导出被取消选择。
-- 导出  表 sanshanblog.markdown_blog 结构
...
-- 数据导出被取消选择。
-- 导出  表 sanshanblog.ueditor_blog 结构
...
-- 数据导出被取消选择。
-- 导出  表 sanshanblog.ueditor_file_quote 结构
...
-- 数据导出被取消选择。
-- 导出  表 sanshanblog.ueditor_id_file_map 结构
